...
val adds : register -> register -> 'a operand -> 'a -> text
val subs : register -> register -> 'a operand -> 'a -> text
val divs : register -> register -> 'a operand -> 'a -> text
val muls : register -> register -> 'a operand -> 'a -> text
val ceqs : register -> register -> text
val cles : register -> register -> text
val clts : register -> register -> text
val mtc1 : register -> register -> text
val mtc0 : register -> register -> text
val bc1f : label -> text
...
val addi : register -> register -> 'a operand -> 'a -> text
